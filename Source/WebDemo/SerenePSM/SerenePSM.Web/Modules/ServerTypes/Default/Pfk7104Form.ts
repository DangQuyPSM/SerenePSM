...
export interface Pfk7104Form {
    SeSizeGroup: StringEditor;
    CdSizeGroup: StringEditor;
    CustomerCode: StringEditor;
    SizeRangeName: StringEditor;
    SizeRangeSimpleName: StringEditor;
...
export class Pfk7104Form extends PrefixedContext {
    static readonly formKey = 'Default.Pfk7104';
    ...
    constructor(prefix: string) {
        ...
        if (!Pfk7104Form.init)  {
            Pfk7104Form.init = true;

            var w0 = StringEditor;

            initFormType(Pfk7104Form, [
                'SeSizeGroup', w0,
                'CdSizeGroup', w0,
                'CustomerCode', w0,
                'SizeRangeName', w0,
                'SizeRangeSimpleName', w0,
                'SeGender', w0,
                'CdGender', w0,
                'SeSeason', w0,
                'CdSeason', w0,
