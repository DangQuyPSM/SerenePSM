...
public static partial class Texts
{
    ...
    public static class Forms
    {
        public static class Membership
        {
            ...
            {
                public static readonly LocalText ActivateEmailSubject = "Activate Your SerenePSM Account";
        ...
        public static readonly LocalText SiteTitle = "SerenePSM";
    }

    public static class Navigation
    {
        public static readonly LocalText Dashboard = "PSM Team";
