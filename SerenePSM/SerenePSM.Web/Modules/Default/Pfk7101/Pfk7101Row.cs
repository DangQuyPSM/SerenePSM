...
public sealed class Pfk7101Row : Row<Pfk7101Row.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Representative"), Column("K7101_Representative"), Size(50), NotNull]
    public string Representative { get => fields.Representative[this]; set => fields.Representative[this] = value; }

    [DisplayName("Address No"), Column("K7101_AddressNo"), Size(100), NotNull]
    ...
    [DisplayName("Destination"), Column("K7101_Destination"), Size(500)]
    ...
    [DisplayName("Se Cancel Date"), Column("K7101_seCancelDate"), Size(3)]
    public string SeCancelDate { get => fields.SeCancelDate[this]; set => fields.SeCancelDate[this] = value; }

    [DisplayName("Cd Cancel Date"), Column("K7101_cdCancelDate"), Size(3)]
